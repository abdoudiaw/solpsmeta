...
def _extract_vector_from_params(meta: dict):
    ...
    core_density = float(_safe_get(meta, "inputs.core.particle_flux_s-1", 0.0) or 0.0)
...
def upsert_case_to_sqlite(sqlite_path: str, params_path: str, returncode: int,
    ...
    puff_d2, puff_ne, ptot_w, core_density, dna, hci, hce  = _extract_vector_from_params(meta)
